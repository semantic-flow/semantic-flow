...
import { setGlobalLoggingConfig } from "../flow-core/src/utils/logger/component-logger.ts";
...
setGlobalLoggingConfig(SERVICE_LOGGER_DEFAULT_CONFIG);
...
try {
  ...
  setGlobalLoggingConfig(loggingConfig);
